...
const CatalogeEssencePage = () => {
  ...
  const filteredVehicles = data?.vehicles.filter((vehicle: Vehicle) => {
    ...
    const isElectric = ((vehicle.propulsion.toString() === "ESSENCE") && !isScooter);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-bold">Nos Véhicules À Essence</h1>
        </div>
...
export default CatalogeEssencePage;