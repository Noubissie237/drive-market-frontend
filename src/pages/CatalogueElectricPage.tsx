...
const CatalogeElectricPage = () => {
  ...
  const filteredVehicles = data?.vehicles.filter((vehicle: Vehicle) => {
    ...
    const isScooter = vehicle.type.toString() === "SCOOTER";
    const isElectric = ((vehicle.propulsion.toString() === "ELECTRIC") && !isScooter);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-4xl font-bold">Nos Véhicules Électriques</h1>
        </div>
...
export default CatalogeElectricPage;